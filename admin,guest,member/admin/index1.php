...
<header>
    ...
    <nav class="navbar">
        ...
        <a href="/admin,guest,member/front.php" style="text-decoration: underline; color:red;"class="logout">Log Out</a>
            </nav>
...
<section class="register" id="contact">
  ...
  <p><strong><em>YOU ARE NOT REGESTERED YET TO BOOK THE DATE. SO REGISTER FIRST; FOR REGISTRATION <a href="/admin,guest,member/register.php">CLICK HERE-></a></em></strong></p>
</section>
